...
class MyTrainersList extends StatelessWidget {
  const MyTrainersList({super.key, required this.type});
  final int type;

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PlansCubit()..loadMyTrainers(),
