...
import '../pages/prducts_page.dart';
          ...
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => ProductsListPage(
                      produitList: items[index].productList, title: items[index].name,
                    )));
          },
          child: Center(
            child: Padding(
...
class ProductInfo {
  ...
  ProductInfo(this.name, this.startColor, this.endColor, this.rating,
      this.location, this.category, this.icon, this.productList);
}
